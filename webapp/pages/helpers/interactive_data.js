...
// TODO(dcramer); this is a bit of a mess as underscore.create has invalid
// behavior for Object.create, and its a PITA to replicate
/*
  ...
  return _.create(Object.prototype, {
    ...
    */
    initialize(initial_params) {
      ...
      this.elem.setState({[this.elemStateKey]: this}, ___ => {
    ...
    */
    getCurrentParams() {
      return {...this._getDataAndParamsToShow()['params']};
    },
    ...
    */
    updateWithParams(new_params, reset_page = false) {
      ...
      var new_params = {...this.getCurrentParams(), ...new_params};
    ...
    _fetchNewestData(params) {
      ...
      this.elem.setState({[this.elemStateKey]: this});
    ...
    getPagingLinks(options = {}) {
      ...
      links.push(
        <Button
          ...
          href={
            params.previous ? URI(window.location.href).query(params.previous) : null
          }>
